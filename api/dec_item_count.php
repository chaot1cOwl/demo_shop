...
if (isset($_POST["id"])) { // если пришли все нужные данные
  ...
  } else { // товар в корзине есть - уменьшаем количество
    $_SESSION["cart"][$_POST["id"]]["count"]--;
    if ($_SESSION["cart"][$_POST["id"]]["count"] == 0) { // если это был последний такой товар в корзине - убираем всю информацию о нем
